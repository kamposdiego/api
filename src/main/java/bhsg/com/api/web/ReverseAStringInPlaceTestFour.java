...
public class ReverseAStringInPlaceTestFour {

    public static void main(String args[]){
        System.out.println(reverseAStringInPlaceTestFour("abc"));
    }

    private static String reverseAStringInPlaceTestFour(String value){
